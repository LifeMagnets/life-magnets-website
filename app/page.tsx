...
function SectionWave({ fill = 'rgba(126,196,205,0.32)' }: { fill?: string }) {
  return (
    ...
    <div>
      ...
      <section style={{ background: 'linear-gradient(to top, #a8cfe0 0%, #c4e0ec 35%, #e0f2f8 70%, #fff 100%)', padding: '48px 16px 64px', textAlign: 'center', position: 'relative' }}>
        <div style={{ maxWidth: 700, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '1.3rem', color: '#6a8e95', marginBottom: 44, lineHeight: 1.7, fontWeight: 500 }}>
          ...
          <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}>
            {[
              ...
              <Link key={btn.href} href={btn.href} className="btn" style={{
                ...
                background: `radial-gradient(ellipse, rgba(255,255,255,0.2) 0%, rgba(255,255,255,0) 70%), #5ba3ac`,
              }}>
                {btn.label}
              </Link>
            ))}
      ...
      <section style={{ background: '#e8c46e', textAlign: 'center', position: 'relative', overflow: 'visible' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, padding: '80px 16px' }}>
          <div style={{ maxWidth: 900, margin: '0 auto' }}>
            ...
            <Link href="/custom" className="btn" style={{ display: 'inline-block', padding: '14px 36px', background: 'white', color: '#b89558', fontWeight: 800, fontSize: '1rem', textDecoration: 'none', borderRadius: 12 }}>
              Shop Custom Options
            </Link>
          </div>
        </div>
      ...
      <section style={{ background: '#c8675d', position: 'relative', overflow: 'visible' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, padding: '80px 16px' }}>
          <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 60, flexWrap: 'wrap' }}>
            <div style={{ flex: 1, minWidth: 280, padding: '0 32px' }}>
              ...
              <h2 style={{ color: 'white', fontSize: '2.2rem', fontWeight: 800, lineHeight: 1.2, marginBottom: 20 }}>Bring our Booth<br />to Your Live Event</h2>
              ...
              <Link href="/events" className="btn" style={{ display: 'inline-block', padding: '13px 30px', background: 'white', color: '#c8675d', fontWeight: 800, fontSize: '0.95rem', textDecoration: 'none', borderRadius: 10 }}>
                More Info
              </Link>
            </div>
      ...
      <section style={{ background: '#5ba3ac', position: 'relative', overflow: 'visible' }}>
        <SectionWave />
        <div style={{ position: 'relative', zIndex: 1, padding: '80px 16px' }}>
          <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 60, flexWrap: 'wrap-reverse' }}>
            ...
            <div style={{ flex: 1, minWidth: 280, padding: '0 32px' }}>
              ...
              <Link href="/custom" className="btn" style={{ display: 'inline-block', padding: '13px 30px', background: 'white', color: '#5ba3ac', fontWeight: 800, fontSize: '0.95rem', textDecoration: 'none', borderRadius: 10 }}>
                Start Creating
              </Link>
            </div>
          </div>
      ...
      <section style={{ background: 'linear-gradient(to bottom, #f5e9d0 0%, #dfc49a 55%, #aa8860 100%)', position: 'relative', overflow: 'visible' }}>
        <SectionWave />
        ...
        <div style={{ position: 'relative', zIndex: 1, padding: '80px 16px' }}>
          <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 60, flexWrap: 'wrap' }}>
            <div style={{ flex: 1, minWidth: 280, padding: '0 32px' }}>
              <div style={{ fontSize: '0.8rem', fontWeight: 800, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#b89558', marginBottom: 16 }}>Shop</div>
            ...
            <div style={{ flex: 1, minWidth: 280, display: 'flex', justifyContent: 'center' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                {[96, 80, 80, 96].map((size, i) => (
                  <div key={i} style={{ width: size, height: size, background: 'rgba(91,163,172,0.1)', border: '2px solid rgba(91,163,172,0.3)', borderRadius: 8 }} />
                ))}
              </div>
            </div>
          </div>
        ...
        <svg viewBox="0 0 1440 220" preserveAspectRatio="none" style={{ position: 'absolute', bottom: 0, left: 0, width: '100%', height: '37%', zIndex: 0 }}>
          <defs>
            <linearGradient id="waveGrad1" x1="0" y1="0" x2="0" y2="1">
              ...
              <stop offset="100%" stopColor="rgba(200,235,238,0.55)" />
            </linearGradient>
            <linearGradient id="waveGrad2" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="rgba(126,196,205,0)" />
              <stop offset="100%" stopColor="rgba(126,196,205,0.5)" />
            </linearGradient>
            <linearGradient id="waveGrad3" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="rgba(91,163,172,0)" />
              <stop offset="100%" stopColor="rgba(91,163,172,0.45)" />
            </linearGradient>
          </defs>
        ...
        <div style={{ padding: '60px 16px 80px', textAlign: 'center', position: 'relative', zIndex: 1 }}>
          <div style={{ maxWidth: 600, margin: '0 auto' }}>
            <h2 style={{ color: '#5ba3ac', fontSize: '2rem', fontWeight: 800, marginBottom: 14 }}>Ready to make some magnets?</h2>
            <p style={{ color: '#6a8e95', fontSize: '1.05rem', marginBottom: 36 }}>Upload your photos and we'll take it from there.</p>
            <Link href="/custom" className="btn" style={{ display: 'inline-block', padding: '16px 44px', background: '#5ba3ac', color: 'white', fontWeight: 800, fontSize: '1.05rem', textDecoration: 'none', borderRadius: 12 }}>
