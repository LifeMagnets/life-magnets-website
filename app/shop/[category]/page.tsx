...
const categoryMeta: Record<string, { label: string; tagline: string; accent: string; bg: string }> = {
  'holidays-seasons': {
    ...
    accent: '#f0b429',
    bg: 'linear-gradient(to bottom, #fffbef 0%, #fdf0c0 100%)',
  },
  'home': {
    label: 'Home',
    tagline: 'Creative, practical, or just fun designs for your home or office.',
    accent: '#e8734a',
    bg: 'linear-gradient(to bottom, #fff4ef 0%, #f5e6c8 100%)',
  },
  'kids': {
    label: 'Kids',
  ...
  'sports-adventure': {
    ...
    accent: '#aa8860',
    bg: 'linear-gradient(to bottom, #f8f0e8 0%, #f5e6c8 100%)',
  },
}
    ...
    return (
      <div style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center' }}>
          <h1 style={{ color: '#0097a7', fontSize: '1.8rem', fontWeight: 800, marginBottom: 12 }}>Category not found</h1>
          <Link href="/shop" style={{ color: '#0097a7', fontWeight: 700 }}>← Back to Shop</Link>
        </div>
      </div>
    )
  }
    ...
    <div>
      ...
      <section style={{ background: meta.bg, padding: '64px 16px 56px', textAlign: 'center' }}>
        <div style={{ maxWidth: 640, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '1.05rem', color: '#4a7a84', lineHeight: 1.7 }}>{meta.tagline}</p>
        </div>
      </section>
      ...
      <section style={{ background: '#fafaf8', padding: '80px 16px', textAlign: 'center' }}>
        <div style={{ maxWidth: 600, margin: '0 auto' }}>
          <div style={{ width: 80, height: 80, borderRadius: '50%', background: 'rgba(0,151,167,0.08)', border: '2px solid rgba(0,151,167,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 28px' }}>
            <div style={{ width: 40, height: 40, borderRadius: 6, background: 'rgba(0,151,167,0.15)', border: '2px solid rgba(0,151,167,0.3)' }} />
          </div>
          <h2 style={{ color: '#1a3a40', fontSize: '1.6rem', fontWeight: 800, marginBottom: 14 }}>Designs Coming Soon</h2>
          <p style={{ color: '#4a7a84', fontSize: '1rem', lineHeight: 1.7, marginBottom: 36 }}>
